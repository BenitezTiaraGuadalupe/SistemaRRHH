...
<aside class="sidebar" aria-label="Menú lateral">
    <a class="brand" href="<?php echo htmlspecialchars(AuthController::urlInicio(), ENT_QUOTES, 'UTF-8'); ?>" aria-label="Inicio">
    ...
    <nav class="menu" aria-label="Principal">
        <?php foreach ($itemsPrincipal as $item) : ?>
            ...
            <a class="<?php echo $claseActiva; ?>" href="<?php echo htmlspecialchars($item['href'], ENT_QUOTES, 'UTF-8'); ?>">
                <span class="menu-label"><?php echo htmlspecialchars($etiqueta, ENT_QUOTES, 'UTF-8'); ?></span>
            </a>
        <?php endforeach; ?>
    </nav>
