...
$menuPrincipal = array(
    array('key' => 'dashboard',     'label' => 'Dashboard',         'href' => 'index.php?accion=index',  'permiso' => 'dashboard.ver'),
    array('key' => 'solicitudes',   'label' => 'Solicitudes',       'href' => 'index.php?accion=index',  'permiso' => 'solicitudes.ver'),
    array('key' => 'ofertas',       'label' => 'Ofertas laborales', 'href' => '#',                       'permiso' => 'ofertas.ver'),
    array('key' => 'candidatos',    'label' => 'Candidatos',        'href' => '#',                       'permiso' => 'candidatos.ver'),
...
/**
 * Devuelve un SVG inline (sin width/height, hereda del contenedor).
 */
function layout_icono($key)
{
    $svgs = array(
        ...
        'solicitudes'   => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M14 3H7a2 2 0 0 0-2 2v14a2 2 0 0 0 2 2h10a2 2 0 0 0 2-2V8z"/><path d="M14 3v5h5"/><path d="M9 13h6"/><path d="M9 17h6"/></svg>',
        'ofertas'       => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="3" y="7" width="18" height="13" rx="2"/><path d="M8 7V5a2 2 0 0 1 2-2h4a2 2 0 0 1 2 2v2"/><path d="M3 12h18"/></svg>',
        'candidatos'    => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="12" cy="8" r="4"/><path d="M4 21c0-4 4-7 8-7s8 3 8 7"/></svg>',
        'postulaciones' => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M22 2L11 13"/><path d="M22 2l-7 20-4-9-9-4 20-7z"/></svg>',
        'empresas'      => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><rect x="4" y="3" width="16" height="18" rx="1.5"/><path d="M9 7h2M9 11h2M9 15h2M13 7h2M13 11h2M13 15h2"/></svg>',
        'reportes'      => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><path d="M3 3v18h18"/><path d="M7 14l4-4 3 3 5-6"/></svg>',
        'usuarios'      => '<svg viewBox="0 0 24 24" fill="none" stroke="currentColor" stroke-width="1.7" stroke-linecap="round" stroke-linejoin="round"><circle cx="9" cy="8" r="3.5"/><path d="M2.5 20c0-3.3 2.9-6 6.5-6s6.5 2.7 6.5 6"/><circle cx="17" cy="9" r="2.5"/><path d="M21.5 18.5c0-2.2-2-4-4.5-4"/></svg>',
...
<body>
    <div class="app">
        <aside class="sidebar" aria-label="Menú lateral">
            <a class="brand" href="index.php?accion=index" aria-label="Inicio">
